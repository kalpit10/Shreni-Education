...
function NavitaTewariModal({ isVisible, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-zinc-950 bg-opacity-35 backdrop-blur-lg flex justify-center items-center h-full">
      <div className="text-white w-11/12 h-5/6 overflow-y-auto rounded-lg p-4">
        ...
        <div className="mt-4">
          ...
          <p>
            ...
            Education with over 27 years of teaching experience as{" "}
